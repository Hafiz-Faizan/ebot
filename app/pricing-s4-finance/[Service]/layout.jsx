...
export default function S4FinanceLayout(params) {
    const service = (params.params.Service);

    const imageSrc=service === "bookkeeping" ? '/BookKeeping.jpg' : service === "Accounting" ? '/acounting.jpg' : service === "Fractional%20CFO" ? '/CFO.jpg' : '/sap.jpg'
